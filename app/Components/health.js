...
export default function HealthPage()
{
  ...
  return (
    <section id="health" className="w-full h-svh bg-[#30493D] flex flex-col md:flex-row overflow-hidden gap-8 lg:gap-0">
      ...
      <div className='md:w-[60%] w-full h-[90vh] md:h-[100vh] flex flex-col items-center justify-start md:justify-center gap-8'>
        <p ref={(el) => (textRefs.current[0] = el)} className='w-[80%] text-[#CED1BF] text-[1rem] xl:text-[1.5rem]'>
          &nbsp;&nbsp;&nbsp;<span className='text-[#CA7D57]'>Hypercholesterolemia</span> commonly referred to as high cholesterol, is a condition in which excess cholesterol circulates in the bloodstream, increasing the risk of heart disease and stroke.
        </p>
