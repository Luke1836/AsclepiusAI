...
export default function HealthPage()
{
  ...
  return (
    <section id="health" className="w-full h-svh bg-[#30493D] flex flex-col md:flex-row overflow-hidden gap-8 md:gap-0">
      <div className="w-full md:w-[50%] h-[5rem] md:h-[100vh] grid place-content-center">
        ...
        <div className="hidden md:block w-full h-full pr-16 py-16" >
          <div className="section-2" ref={componentRef} >  
      ...
      <div className='md:w-[60%] w-full h-[90vh] md:h-[100vh] flex flex-col items-center justify-start md:justify-center gap-8'>
          <p className='w-[80%] text-[#CED1BF] text-[1rem] xl:text-[1.5rem]'>
          ...
          <p className='text-[#CED1BF] w-[80%] text-[1rem] xl:text-[1.5rem] hidden md:block'>
